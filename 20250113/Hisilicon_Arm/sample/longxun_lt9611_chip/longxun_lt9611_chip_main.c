...
u8 HDMI_WriteI2C_Byte(u16 RegAddr, u16 d)
{
	usleep(10);
    bool flag = false;
...
void LT9611_Power_On(void)
{
    //gpiod_set_value(lt9611->power_gpio,1);
    usleep(5 * 1000);
    printf("set power High level.\n ");

}

void LT9611_Reset(void)
{
    // gpiod_set_value(lt9611->reset_gpio,1);
    // msleep(5);
    // gpiod_set_value(lt9611->reset_gpio,0);
    // msleep(5);
    // gpiod_set_value(lt9611->reset_gpio,1);
    // msleep(5);

    gpio_test_out_copy(11,2,1);
    usleep(5*1000);
    gpio_test_out_copy(11,2,0);
    usleep(5*1000);
    gpio_test_out_copy(11,2,1);
    usleep(5*1000);
