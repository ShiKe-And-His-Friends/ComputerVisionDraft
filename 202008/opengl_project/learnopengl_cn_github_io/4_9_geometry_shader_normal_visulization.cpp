...
int main () {
	...
	Shader shader("./raw/9.3.default.vs" ,"./raw/9.3.default.fs");
	Shader normalShader("./raw/9.3.normal_visualization.vs", "./raw/9.3.normal_visualization.fs", "9.3.normal_visualization.gs");
