...
int main () {
	...
	Shader simpleDepthShader("./raw/3.1.1.shadow_mapping_depth.vs" ,"./raw/3.1.1.shadow_mapping_depth.fs");
	Shader debugDepthQuad("./raw/3.1.1.debug_quad.vs" ,"./raw/3.1.1.debug_quad_depth.fs");
