...
int main () {
	...
	Shader shader("./raw/3.1.2.shadow_mapping.vs" ,"./raw/3.1.2.shadow_mapping.fs");
	Shader simpleDepthShader("./raw/3.1.2.shadow_mapping_depth.vs" ,"./raw/3.1.2.shadow_mapping_depth.fs");
	Shader debugDepthQuad("./raw/3.1.2.debug_quad.vs" ,"./raw/3.1.2.debug_quad_depth.fs");
