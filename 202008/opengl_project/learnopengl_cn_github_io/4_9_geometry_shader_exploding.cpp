...
int main () {
	...
	Shader shader("./raw/9.2.geometry_shader.vs" ,"./raw/9.2.geometry_shader.fs" ,"./raw/9.2.geometry_shader.gs");
	Model nanosuit("./");
	...
	while(!glfwWindowShouldClose(window)) {
		...
		glm::mat4 projection = glm::perspective(glm::radins(45.0f) ,(float)SCR_WIDTH/(float)SCR_HEIGHT ,1.0f ,100.0f);
