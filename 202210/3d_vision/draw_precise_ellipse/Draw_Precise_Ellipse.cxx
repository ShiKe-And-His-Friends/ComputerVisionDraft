#include "DrawPreciseEllipse.hpp"

// 绘制高精度椭圆
int draw_precise_ellipse()
{
	int sigma = 0;
	double length = 600;
	double width = 600;
	...
	waitKey();
	***/
	cv::imwrite("C:/Users/s05559/Desktop/低精度椭圆.jpg", ellipse_CV);
	cv::imwrite("C:/Users/s05559/Desktop/高精度椭圆.jpg", ellipseImg_Area);
